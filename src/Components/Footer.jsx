            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    <div className="text-center gap-8 flex flex-col items-center">
                        <h1 className='text-5xl font-bold'>{landingPageData.footer.title}</h1>

                        <p>{landingPageData.footer.description}</p>
                        <button className="group inline-flex items-center justify-center border-2 border-gray-200 py-3 rounded hover:rounded-3xl w-2/4 font-semibold focus:outline-none text-center hover:bg-[#dadada] hover:text-black text-xl mt-4 md:mt-0 transition-all duration-300">
                            ...
                            <svg
                                ...
                                strokeWidth={2}
                                className="w-8 h-8 ml-1 transform transition-all duration-300 group-hover:translate-x-8"
                                viewBox="0 0 24 24"
                            >
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200">
                        <li>
                            <a href="#" className="text-[#dadada] hover:text-[#dadada]">
                                Pagedone
                            </a>
                        </li>
                        <li>
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a
                            href="#"
                            className="block  text-[#dadada] transition-all duration-500 hover:text-indigo-600 "
                        >
                            <svg
